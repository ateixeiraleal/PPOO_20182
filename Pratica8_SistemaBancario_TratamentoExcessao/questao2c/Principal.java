...
//     try{
         if(ag.depositar(pedirContaDestino(),pedirValor())) {
            System.out.println("Deposito realizado com sucesso!!!");
             ...
             System.out.println("Depósito não realizado, conta inexistente!!!");
         }
//     }
//     catch(Exception e){
...
//     }
  ...
  private static void sacar(){
    if(ag.sacar(pedirContaDestino(),pedirValor())) {
        ...
        System.out.println("Saque não efetuado, conta inexistente!!!");
    }
  }
  ...
  private static void transferir(){
    if(ag.transferir(pedirContaOrigem(),pedirContaDestino(),pedirValor())) {
        ...
        System.out.println("Transferência não efetuada, conta inexistente!!!");
    }
  }
