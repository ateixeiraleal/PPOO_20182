...
public class Principal{
  ...
  private static void depositar(){
    ...
    {
        ag.getQdeContas();
        int conta = pedirContaDestino();
        ag.depositar(conta,pedirValor());
  ...
  private static void sacar(){
    ...
    {
        ag.getQdeContas();
        int conta = pedirContaOrigem();
        double valor = pedirValor();
        ag.sacar(conta,valor);
  ...
  private static void transferir(){
    ...
    catch(ContaInvalidaException | SaldoInvalidoException e){
      System.out.println(e.getMessage());
    }
  }
